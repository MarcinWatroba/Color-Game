...
function generateCallbacks() {
    ...
    // buttonPosTop = $(".level:last").position().top;
    // bodyWidth = $("body").width();
    // if(screenWidth === 0)
    // {
    //     hideWidth = $(".level:last").position().left  + width;
    //     console.log("body: " + bodyWidth + "hide: " + hideWidth);
    //     if((bodyWidth - hideWidth) < 5) {
    //         screenWidth = bodyWidth;
    ...
    // if(screenWidth === 0)
    // {
    //     let newPos = $(".level:last").position().top;
    //     if(newPos > buttonPos)
    //     {

    //     }
    //     else if(newPos < buttonPos)
    //     {
